...
- [ ] Setup vendor for Configuration
...
|---------------------|----------------------------------|---------|
| Set variable        | Create or update env variable    |         |
| Get variable        | Read env variable value          |         |
| Delete variable     | Remove env variable              |         |
| List variables      | List all env variables           |         |
| Switch environment  | Change active environment        |         |
| Check variable      | Check if variable exists         |         |
...
- [ ] Setup vendor for Task Management
- [ ] Update this section with vendor-specific operation commands
...
| Operation        | Description                       | Command |
|------------------|-----------------------------------|---------|
| Store memory     | Save context/memory               |         |
| Retrieve memory  | Get stored memory                 |         |
...
| Operation        | Description                       | Command |
|------------------|-----------------------------------|---------|
| Send message     | Send message to channel/user      |         |
| Receive message  | Handle incoming messages          |         |
| Create thread    | Create new thread/channel         |         |
...
| Operation        | Description                       | Command |
|------------------|-----------------------------------|---------|
| Trigger build    | Start a new build/pipeline        |         |
| Get build status | Check build status                |         |
| Cancel build     | Cancel running build              |         |
| List builds      | List recent builds                |         |
| Get build logs   | Retrieve build logs               |         |
| Retry build      | Retry failed build                |         |
...
| Operation        | Description                       | Command |
|------------------|-----------------------------------|---------|
| Query metrics    | Query metric values               |         |
| Search logs      | Search through logs               |         |
| Get traces       | Retrieve distributed traces       |         |
| Create alert     | Create alerting rule              |         |
| List alerts      | List configured alerts            |         |
| Get dashboards   | List/view dashboards              |         |
...
| Deploy docs      | Deploy docs to hosting            |         |
| Preview docs     | Local preview of docs             |         |
...
| Export translations   | Export for translation         |         |
| List locales          | List supported locales         |         |
| Validate translations | Check translation completeness |         |
| Sync translations     | Sync with translation service  |         |
